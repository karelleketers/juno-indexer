# SubQuery - Starter Package for Cosmos/Juno
...
If you run a multi-chain, you will need to generate types for each chain, you do this with: 

```
yarn codegen --file ./project-terra.yaml
```

...this is for the terra chain. For other chains or networks you replace *terra* with the relevant chain. 
